...
//#define UART_PIN_RX             IfxAsclin0_RXB_P15_1_IN                 /* UART receive port pin                    */
//#define UART_PIN_TX             IfxAsclin0_TX_P15_0_OUT                 /* UART transmit port pin                   */
...
void asclin0RxISR(void)
{
    ...
    for(int i=0; i < MAX_RCV_BUFFER_SIZE; i++)
    {
...
void receive_ASCLIN_UART_message(Ifx_SizeT cnt)
{
